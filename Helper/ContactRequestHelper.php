...
namespace MauticPlugin\LeuchtfeuerIdentitySyncBundle\Helper;
...
/**
 * This class was copied and modified from \Mautic\LeadBundle\Helper\ContactRequestHelper, because all its attributes
 * and most methods are private instead of protected, which makes class-extending impossible to overwrite features.
 */
class ContactRequestHelper
{
    ...
    public function getContactFromQuery(array $queryFields = []): ?Lead
    {
        ...
        if (!$this->trackedContact) {
            $this->trackedContact = $this->contactTracker->getContact(); // this creates cookies and lead
        }
     ...
     * @throws ContactNotFoundException
     */
    private function getContactFromClickthrough(array $clickthrough): Lead
    {
    ...
    /**
     * @return void
     * @throws \Mautic\LeadBundle\Exception\ImportFailedException
     */
     ...
     * @return Lead
     */
    private function mergeWithTrackedContact(Lead $foundContact): Lead
    {
